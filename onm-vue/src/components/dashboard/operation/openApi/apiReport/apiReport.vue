      ...
      <v-card>
        <count-api-tab></count-api-tab>
          ...
          <v-container>
            ...
            v-bind:param=searchParam
            ></avg-api-time>
            <count-call-api></count-call-api>
            <count-call-store></count-call-store>
          </v-container>
      </v-card>     
    </v-container>
</template>
...
import AvgApiTime from './avgApiTime.vue'
import CountCallApi from './countCallApi.vue'
import CountCallStore from './countCallStore.vue'
...
export default {
  ...
  methods: {   
    ...
    setToSearchParams: function(values){
      console.log("____________________________"+values)

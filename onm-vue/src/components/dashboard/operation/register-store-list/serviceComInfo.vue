               ...
               if(this.receivedInfo.site_id){
                ...
                .then((response) => {
                    ...
                    if(resCode == 200){
                        ...
                        this.infoObject.site_id = response.data.data.site_id;  
                        this.infoObject.site_name = response.data.data.site_name;
                        this.infoObject.status_code = response.data.data.status_code;
                        this.infoObject.user_name = response.data.data.user_name;
                        this.infoObject.mod_date = response.data.data.mod_date;
                        this.infoObject.reg_date = response.data.data.reg_date;
                        this.infoObject.adm_id = response.data.data.adm_id;
                        this.infoObject.tel_no = response.data.data.tel_no;
                        this.infoObject.adm_access_date = response.data.data.adm_access_date;
                        this.infoObject.control_type = response.data.data.control_type;
                        this.infoObject.site_access_limit = response.data.data.site_access_limit;
                        this.infoObject.access_limit_type = response.data.data.access_limit_type;
